  ...
  _proto.load = function load(subtitlesOptions) {
    ...
    if (subtitlesOptions && subtitlesOptions.length) {
      ...
      var subtitles = subtitlesOptions.map(function (optionItem, optionIndex) {
        var subtitle = _extends__default['default']({}, optionItem);
        ...
        var trackEl = player.addRemoteTextTrack(_extends__default['default']({}, subtitle, {
          default: false
        }), manualCleanup);
...
var BezelText = /*#__PURE__*/function (_Component) {
  _inheritsLoose__default['default'](BezelText, _Component);
...
var BezelTextWrapper = /*#__PURE__*/function (_Component2) {
  _inheritsLoose__default['default'](BezelTextWrapper, _Component2);
...
var Bezel = /*#__PURE__*/function (_Component3) {
  _inheritsLoose__default['default'](Bezel, _Component3);
...
var FullwindowToggle = /*#__PURE__*/function (_Button) {
  _inheritsLoose__default['default'](FullwindowToggle, _Button);
  ...
  function FullwindowToggle(player, options) {
    ...
    var autoEvent = _this.autoEvent = autoDisposeEvent(player, _assertThisInitialized__default['default'](_this));
