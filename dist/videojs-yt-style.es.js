...
var frameEvent = function frameEvent(videoElement, func) {
  ...
  var ticker = function ticker(useless, metadata) {
    ...
    if (diff && diff < 1 && frameNotSeeked && fpsRounder.length < 50 && vid.playbackRate === 1 && document.hasFocus()) {
...
var SubtitleManager = /*#__PURE__*/function () {
  ...
  _proto.default = function _default() {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(allTextTrack.entries()), _step; !(_step = _iterator()).done;) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(window.navigator.languages), _step2; !(_step2 = _iterator2()).done;) {
...
var BezelText = /*#__PURE__*/function (_Component) {
  _inheritsLoose(BezelText, _Component);
...
var BezelTextWrapper = /*#__PURE__*/function (_Component2) {
  _inheritsLoose(BezelTextWrapper, _Component2);
...
var Bezel = /*#__PURE__*/function (_Component3) {
  _inheritsLoose(Bezel, _Component3);
...
var keepVolume = function keepVolume(player) {
  ...
  try {
    var data = JSON.parse(window.localStorage.getItem(LOCAL_STORAGE_KEY));
    values = {
      muted: data.muted,
...
var FullwindowToggle = /*#__PURE__*/function (_Button) {
  ...
  function FullwindowToggle(player, options) {
    ...
    var autoEvent = _this.autoEvent = autoDisposeEvent(player, _assertThisInitialized(_this));
...
var dashHlsBitrateSwitcher = function dashHlsBitrateSwitcher(player) {
  if (player.usingPlugin('dashHlsBitrateSwitcher')) {
    ...
    player.one('loadstart', function () {
      player.one(videojs.browser.IS_IOS ? 'canplaythrough' : 'loadedmetadata', function () {
